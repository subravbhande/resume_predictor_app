...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("### Welcome to the Resume App")
        st.markdown("---")
        ...
        st.markdown("Made with love for you")
        ...
        with st.expander("Give Feedback"):
            ...
            if not st.session_state.feedback_submitted:
                ...
                rating = st.radio("Your Rating:", ["1", "2", "3", "4", "5"], index=None, horizontal=True)
                ...
                if st.button("Send Feedback"):
                    if rating is None:
                        ...
                        st.warning("Please select what you liked.")
                    else:
    ...
    if menu_option == "Resume Analysis":
        ...
        st.markdown("Resources to boost your career growth, learning, and visibility.")
